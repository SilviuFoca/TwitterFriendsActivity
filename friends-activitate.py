...
Driver = config.get('Conectare', 'Driver')
Server = config.get('Conectare', 'Server')
Database = config.get('Conectare', 'Database')
uid = config.get('Conectare', 'uid')
pwd = config.get('Conectare', 'pwd')
